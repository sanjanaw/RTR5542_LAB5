...
Vertex** read(PlyFile* input, int *countvertex, int *countfaces, Face*** plyFaces, float* cenx, float* ceny, float* cenz)
{
	...
	//for (int i = 0; i < vertexcount; i++) std::cout << "\n" << i << "     " << vertices[i]->x << "     " << vertices[i]->y << "     " << vertices[i]->z;
	*countvertex = vertexcount;
